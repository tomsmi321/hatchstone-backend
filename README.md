...
## [View Live application](hatchstone-onboaring.netlify.com)

--- 

## GitHub Repository Links:
* [Backend Link](https://github.com/tomsmi321/hatchstone-backend) 
<br>

* [Frontend Link](https://github.com/tomsmi321/hatchstone-frontend) 
...
## **Code Review**
We as a group have made a Pull Request (PR) and then had that reviewed by another group member before merging to Master.
...
During the initial stages of talking to Hatchstone about the application they wanted, we had a few meetings to discuss in detail, followed up by emails to confirm and to show how our progress was.
