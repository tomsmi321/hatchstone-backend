...
const seedDb = async () => {
    ...
    documents: [
      {
        ...
        url:
          'https://hatchstone-documents.s3-ap-southeast-2.amazonaws.com/Company-Verification.png',
        fileName: 'Company-Verification.png',
      },
      {
        name: 'Owner Identification',
        url:
          'https://hatchstone-documents.s3-ap-southeast-2.amazonaws.com/Owner-Identification.jpg',
  ...
  const message1Convo6 = await Message.create({
    ...
    content:
      'Hi Nick, Was good to finally catch up and meet. Thanks for the documents you have uploaded however could please re-upload all as they are quite blurry, sorry for the inconvenience',
    dateCreated: Date.now(),
  })
  ...
  const message2Convo6 = await Message.create({
    ...
    content:
      'Hey Jamie, It was great to finally catch up, no worries that should not be a problem. I will get them to you within the week.',
    dateCreated: Date.now(),
  })
  ...
  const message1Convo7 = await Message.create({
    ...
    content:
      'Hi Jamie, was a bit unsure about which documents you were after after we last spoke, could you please let me know.',
    dateCreated: Date.now(),
  })
  ...
  const message2Convo7 = await Message.create({
    ...
    profileId: profile8._id,
    content:
      'Hi Matt, no worries at all. The remaining document we require is just a photocopy of your drivers license. Thanks',
    dateCreated: Date.now(),
  })
  ...
  const message1Convo8 = await Message.create({
    ...
    profileId: profile8._id,
    content:
      'Hello Reece, I see you have not uploaded any documents yet. Could I please ask that you submit the Company Verification, Owner Identification and Wholesale Investor Certification as soon as possible. Thanks',
    dateCreated: Date.now(),
  })
  ...
  const message2Convo8 = await Message.create({
    ...
    content:
      'Hi Jamie, that is correct I have not uploaded any docs yet, I will get my assistant to do that and hopefully have all available by end of next week.',
    dateCreated: Date.now(),
  })
